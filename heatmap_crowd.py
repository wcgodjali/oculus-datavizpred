...
def crowd_map():
    ...
    # add a title
    ax.set_title('Real-Time Average Human Traffic in D.I.Y. Yogyakarta', fontdict={'fontsize': '18', 'fontweight' : '3'})
    ...
    fig.savefig("map_p_density.png", dpi=300)
    img=cv2.imread('map_p_density.png')
    resized=cv2.resize(img,(720,480))
    cv2.imwrite("send_map_p_density.jpg",resized)
